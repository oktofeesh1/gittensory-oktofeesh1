  ...
  private async checkBeforeStart(input: { owner: string; repo: string; issueNumber?: number | undefined; title?: string | undefined; plannedPaths?: string[] | undefined }): Promise<ToolPayload> {
    ...
    return {
      ...
      data: {
        ...
        // Full report passthrough. buildPreStartCheck routes every reason/blocker/summary through
        // sanitizePublicComment and only carries lane + recommendation metadata (no issue bodies),
        // so this field is public-safe and free of forbidden reward/score/trust terms.
        report: report as unknown as Record<string, unknown>,
      },
    };
  }
